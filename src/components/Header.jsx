...
import {disablePageScrool, enablePageScroll} from 'scroll-lock'
...
const Header = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 w-full z-50 flex items-center border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm ${openNavigation ? "bg-n-8":"bg-n-8/90 backdrop-blur-sm"}`}>
        ...
        <Button 
            className="ml-auto lg:hidden mr-6"
            px="px-3"
